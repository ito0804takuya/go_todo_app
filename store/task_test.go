...
import (
	...
	"github.com/ito0804takuya/go_todo_app/testutil"
)

// task一覧テスト
func TestRepository_ListTasks(t *testing.T) {
	ctx := context.Background()
	// BeginTxxによって、テーブル状態が他のテストケースと混同しないように、トランザクションを貼ることができる
...
func prepareTasks(ctx context.Context, t *testing.T, con Execer) entity.Tasks {
	...
	// NOTE: 複数行のinsertが行われた後のLastInsertIdは、insertされた行の最初のid。
